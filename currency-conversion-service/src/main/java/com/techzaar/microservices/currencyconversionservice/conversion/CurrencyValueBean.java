...
public class CurrencyValueBean {
  ...
  public CurrencyValueBean(int id, String from, String to, BigDecimal conversionMultiple,
      BigDecimal quantity, BigDecimal totalCalculatedValue, int port) {
    super();
    this.id = id;
    this.from = from;
    this.to = to;
  ...
  public String toString() {
    return "CurrencyValueBean [id=" + id + ", from=" + from + ", to=" + to + ", conversionMultiple="
        + conversionMultiple + ", quantity=" + quantity + ", totalCalculatedValue="
        + totalCalculatedValue + ", port=" + port + "]";
  }
